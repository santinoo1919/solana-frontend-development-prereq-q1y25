...
const Requirements = ({ displayRequirements, setDisplayRequirements }) => {
  const requirements = [
    ...
    },
    {
      ...
      description:
        "A CLI tool that lets you manage multiple versions of Node.js",
    },
    {
      title: "GitHub",
  ...
  return (
    <Transition.Root show={displayRequirements} as={React.Fragment}>
      <Dialog
        ...
        onClose={setDisplayRequirements}
      >
        <Transition.Child
          as={React.Fragment}
        ...
        <div className="fixed z-10 inset-0 overflow-y-auto py-8">
          <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative bg-black rounded-lg px-4 text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full sm:p-6">
                <div>
                  <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full  border-2 border-[#2ae436]">
                    <CodeIcon
                      className="h-6 w-6 text-turbine-green"
                      aria-hidden="true"
                    />
                  </div>
                  <div className="text-center mt-3">
                    ...
                    <div className="mt-4 text-left h-40 overflow-scroll rounded-lg px-2 pb-2 min-h-[600px]">
                      {requirements.map((requirement) => (
                        ...
                        >
                          <div className="group border border-zinc-800 rounded-md my-4 p-2">
                            <div className="flex items-center">
                              <LinkIcon
                                width="16px"
                                className="text-zinc-300 mr-1 group-hover:text-turbine-green transition-all duration-200"
                              />
                              <span className="font-semibold text-zinc-300 group-hover:text-turbine-green transition-all duration-200">
                                {requirement.title}
                              </span>
                            </div>
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    type="button"
                    className="inline-flex justify-center w-full rounded-md border-2 border-black shadow-sm px-4 py-2 bg-zinc-900 hover:bg-zinc-800 text-base font-medium text-white sm:text-sm transition-all duration-200"
